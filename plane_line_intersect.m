function [I,check]=plane_line_intersect(n,P,x0,Llab)
%plane_line_intersect computes the intersection of a plane and a segment(or
%a straight line)
% Inputs: 
%       n: normal vector of the Plane 
%       P: Position of the center of the plane
%       x0: Position of the grain
%       Llab: list of vector of the trajectories of the diffraction spots
%       in Lab reference system.
%
%Outputs:
...
u = Llab;
w = x0-P;
D = dot(repmat(n',size(Llab,2),1),u',2);
N = -dot(n',w);
check=0;
