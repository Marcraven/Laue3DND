function [rough,precise,reflections1,reflections2] = compare_G_and_E(B,E,p1,p2)
% reflections=zeros(size(G.reflections,1),14);
e1=E(1).remainingPeaks;
e2=E(2).remainingPeaks;
...
%  hold off
reflections1(:,6)=reflections1(:,8);
reflections2(:,6)=reflections2(:,8);
reflections1(:,8)=[];
reflections2(:,8)=[];
